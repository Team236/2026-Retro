...
public class Swerve extends SubsystemBase {
    ...
    public Command followPathCommand(String pathName) {
        try {
            ...
            SmartDashboard.putNumber("Path start  Rotation",
                    path.getStartingHolonomicPose().get().getRotation().getDegrees());
            ...
            start.setPose(pathStartWaypoint.anchor().getX(), pathStartWaypoint.anchor().getY(),
                    path.getIdealStartingState().rotation());

            FieldObject2d end = field.getObject("PathEnd");
            end.setPose(pathEndWaypoint.anchor().getX(), pathEndWaypoint.anchor().getY(),
    ...
    public void periodic() {
        ...
        for (SwerveModule mod : mSwerveMods) {
            ...
            SmartDashboard.putNumber("Mod " + mod.moduleNumber + " Angle degrees",
